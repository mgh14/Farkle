...
public class Roll {
    ...
    public void setDiceKept(List<DieValue> diceKept) {
        rollScore = new RollScore(diceKept, new ScoreCalculator().calculateRollScore(this));
    }

    public int getScoreForRoll() {
        return (rollScore != null) ? rollScore.getNumberOfPoints() : null;
    }
